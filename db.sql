...
CREATE TABLE `csec_child` (
  ...
  `child_support_other` varchar(5) DEFAULT NULL COMMENT 'Is the child enlisted for support with other organisations',
  `child_support_org` varchar(20) DEFAULT NULL COMMENT 'Name of organisation',
  ...
  `child_live_with` varchar(20) DEFAULT NULL COMMENT 'Who does the child live with',
