...
?>
  ...
  <?php   $id = isset($model->id)?$model->id:0; $keyword = "vetting-remarks"; ?>
<div class="<?= $keyword ?>-form" id="<?= $keyword ?>-form-div-<?= $id ?>">
    ...
    <div class="form-group">
         <?php $url =  Url::to([$model->isNewRecord?'create':'update','id'=>$model->id, 'keyword'=>$keyword, 'view'=>'vetting-remarks']); ?>
